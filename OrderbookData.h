...
class XdpAddOrder : public XdpBaseData
{
  public:
    XdpAddOrder() {}
    XdpAddOrder(char *buffer, const uint16_t length, const uint16_t offset = 0) : XdpBaseData(buffer, length, offset) {}
...
class XdpModifyOrder : public XdpBaseData
{
  public:
    XdpModifyOrder() {}
    XdpModifyOrder(char *buffer, const uint16_t length, const uint16_t offset = 0) : XdpBaseData(buffer, length, offset) {}
